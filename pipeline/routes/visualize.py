...
def route_to_plain_text(route_name: str, route_df: pd.DataFrame):
    """ """
    route_legs = []
    ...
    plan_output = [f"Route #{route_name}:"]
    plan_output.append(
...
def visualize_routes(routes_df, boundary, colors):
    ...
    for key in grouped.groups:
        ...
        if (n - s) == 0 or (e - w) == 0:
            print("""visualize_routes :: map has 0 as a dimension; skipping""")
            continue
